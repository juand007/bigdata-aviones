...
Add shard
```
mongos> sh.addShard("rsbuele/192.168.1.81:50001,192.168.1.81:50002,192.168.1.81:50003")
mongos> sh.status()
```
...
Add shard
```
mongos> sh.addShard("rscueva/192.168.1.81:50004,192.168.1.81:50005,192.168.1.81:50006")
mongos> sh.status()
```
